...
if __name__ == '__main__':
    ...
    for tf_num in range(10):
        ...
        label_list = [raw_label.split(" ") for raw_label in label_list]
        label_list = [(raw_label) for raw_label in label_list]
        all_people_list = [x for x in os.listdir(image_base_path) if str(tf_num) in x[3]]
        people_list = []
