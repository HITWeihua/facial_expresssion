...
# from recalibrate_feature_matrix.model import resnet_dtan_SE as model
from recalibrate_feature_matrix.model import resnet_dtan_SE_cross_channels as model
...
def main(_):
    base_path = "/home/duheran/facial_expresssion/oulu_el_joint"  # oulu_ld_image_joint
    train_correct = []
    test_correct = []
    for i in range(10):
