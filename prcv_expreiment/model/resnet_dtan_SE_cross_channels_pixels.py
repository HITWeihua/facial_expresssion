...
def Squeeze_excitation_layer_cross_channels_pixels(input_x, input_dim, out_dim, ratio, layer_name):
    with tf.variable_scope(layer_name):
        first_dim = int(input_dim*input_dim)
        second_dim = 64
        ...
        excitation = tf.reshape(fc_2, [-1, int(input_dim), int(input_dim), 1])
...
def inference(images, keep_prob, is_train):
    ...
    with tf.variable_scope('block2'):
        ...
        se_layer1 = Squeeze_excitation_layer_cross_channels_pixels(conv3, 64, 64, 16, "se1")
    ...
    with tf.variable_scope('block3'):
        ...
        se_layer2 = Squeeze_excitation_layer_cross_channels_pixels(conv5, 32, 64, 4, "se2")
    ...
    with tf.variable_scope('block4'):
        ...
        se_layer3 = Squeeze_excitation_layer_cross_channels_pixels(conv7, 16, 64, 1, "se3")
    ...
    with tf.variable_scope('block5'):
        ...
        se_layer4 = Squeeze_excitation_layer_cross_channels_pixels(conv8, 8, 64, 1, "se4")
